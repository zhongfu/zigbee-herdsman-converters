...
const converters = {
    ...
    xiaomi_switch_power_outage_memory: {
        ...
        convertSet: async (entity, key, value, meta) => {
            if (['ZNCZ04LM', 'QBKG25LM', 'QBKG26LM'].includes(meta.mapped.model)) {
    ...
    xiaomi_switch_operation_mode: {
        key: ['operation_mode'],
        convertSet: async (entity, key, value, meta) => {
            if (['QBKG11LM', 'QBKG04LM', 'QBKG03LM', 'QBKG12LM', 'QBKG21LM', 'QBKG22LM', 'QBKG23LM', 'QBKG24LM'].includes(meta.mapped.model)) {
